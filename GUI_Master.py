...
def show_FDD_video(video_path):
    ...
    FALLModel=load_model('D:/qnew project/100%fall detection/fall detection updated/full code/FDD_Main_withoutdata/25APRFALLDtection.h5')    #video = cv.VideoCapture(video_path);
    ...
    while True:
        ...
        if  label == 1 :
            ...
            import smtplib
            os.system("Audio.mp3")
            mailid="mayurhetre4@gmail.com"
                    
            msg='Person Fall'
                                
            s = smtplib.SMTP('smtp.gmail.com', 587)
            s.starttls() 
            s.login("falldetection914@gmail.com", "Project@123")
            print(msg)
            s.sendmail('mayurhetre4@gmail.com',mailid,msg)
            TTS = gTTS(text='person fall...person fall.. person fall..person fall')
            TTS.save("voice.mp3")
            os.system("oice.mp3... person fall..person fall")
